...
- add-documentation-command-or-skill-or-agent-or-workflow: Adds a new documentation file for a command, skill, agent, or workflow to the ECC bundle.
- add-team-or-identity-or-research-config: Adds or updates core configuration files for team, identity, or research playbook in the ECC bundle.
