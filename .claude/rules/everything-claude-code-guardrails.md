...
- add-command-or-skill-or-agent-or-workflow: Adds a new command, skill, agent, or workflow to the ECC system.
- add-team-or-identity-or-research-config: Adds or updates configuration for teams, identities, or research in ECC.
