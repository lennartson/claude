...
- add-command-or-skill-or-agent-or-workflow: Adds a new command, skill, agent, or workflow to the ECC system by creating or updating the corresponding markdown file in .claude/commands.
- add-team-or-identity-or-research-config: Adds or updates team, identity, or research configuration files to set up or modify project structure and roles.
