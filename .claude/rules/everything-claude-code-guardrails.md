...
- add-command-or-workflow-doc: Adds documentation for a new command or workflow to the project.
- add-skill-or-agent-doc: Adds documentation for a new skill or agent to the project.
