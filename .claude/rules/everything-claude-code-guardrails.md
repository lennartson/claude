...
- Prefer `conventional` commit messaging with prefixes such as feat, fix.
...
- add-new-skill-command: Adds a new skill command to the system by creating the corresponding markdown documentation.
- add-new-agent-command: Adds a new agent command to the system by creating the corresponding markdown documentation.
