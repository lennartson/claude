...
- add-new-skill-or-agent: Adds a new skill or agent to the everything-claude-code system, including documentation and configuration.
- feature-development-documentation: Documents the process or workflow for developing a new feature in the system.
